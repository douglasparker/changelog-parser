...
while not changelog[changelog_end + len(next_version_string)].isnumeric():
    changelog_end = changelog.find(next_version_string, changelog_end + len(next_version_string))
